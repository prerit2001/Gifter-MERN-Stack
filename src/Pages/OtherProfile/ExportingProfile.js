...
export function ExportingProfile({ match }) {
  ...
  useEffect(() => {
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/checkfollow",
      dataa
    )
      .then((result) => {
        // console.log(result);
  ...
  function Follow() {
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/follow",
      data
    ).then((result) => {
      //  console.log(result);
      setfollow(false);
  ...
  function unFollow() {
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/unfollow",
      data
    ).then((result) => {
      // console.log(result);
      setfollow(true);
  ...
  return (
    <>
          ...
          <FullPage>
            <Full>
              ...
              <SemiFull>
                ...
                {id !== JSON.parse(localStorage.getItem("UserData"))._id && (
                  <>
                    ...
                    {follow && (
                      <>
                        {" "}
                        <Button onClick={Follow} style={{ background: "red" }}>
                          <b>+ FOLLOW +</b>
                        </Button>{" "}
                      </>
                    )}
                ...
                <FollowBox>
                  <Followers>
                    {followers} <br /> Follower
                  </Followers>
                  <Wishes>
                    {wish.length} <br /> Wishes
                  </Wishes>
                  <Following>
      ...
      >
        ...
        >
          Wish Priority: {Priorityy}
        </h4>
        <div
          class="card"
          style={{ width: "400px", border: "1px solid", textAlign: "center" }}
        >
          <img
            class="card-img-top"
            src={Picc}
            alt="Card image"
            style={{ width: "80%", height: "300px", maxWidth: "600px" }}
          />
          <div class="card-body">
            <h4
              class="card-title"
