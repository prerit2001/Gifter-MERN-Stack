...
export const Profile = () => {
  ...
  useEffect(() => {
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/myallpost",
      data
    ).then((result) => {
      //  console.log(result);
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/detailUserFollower",
      data
    ).then((result) => {
      //  console.log(result);
      setdetailFollowes(result.data);
    });
    Axios.post("https://node-backend-gifter.herokuapp.com/api/userfollower", {
      id: USER._id,
    })
      .then((result) => {
        //  console.log(result);
    ...
    Axios.post("https://node-backend-gifter.herokuapp.com/api/userfollowing", {
      id: USER._id,
    })
      .then((result) => {
        //   console.log(result);
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/findallmessages",
      { id: USER._id }
    )
      .then((result) => {
        //  console.log(result.data);
  ...
  function SendMessage() {
    if (message.length < 1 || message.length >= 30) {
      toast.error(
        "Message Coloumn Error : Should be greater than 0 and less than 30 Characters",
    ...
    Axios.post(
      "https://node-backend-gifter.herokuapp.com/api/sendmessage",
      data
    )
      .then((result) => {
        //    console.log(result);
  ...
  function updateProfile() {
    ...
    if (updateName.length === 0 || updateName.length > 50) {
      toast.error(
        "Name Coloumn Error : Should be non-empty less than 50 characters",
        { position: toast.POSITION.TOP_CENTER }
      );
      //return;
      setLoading(false);
    ...
    if (updateBio.length === 0 || updateBio.length > 30) {
      toast.error(
        "Bio Coloumn Error : Should be non-empty less than 50 characters",
        { position: toast.POSITION.TOP_CENTER }
      );
      // return;
      setLoading(false);
    ...
    <>
      ...
      <Something>
              ...
              <form class="form">
                <div class="animate__animated animate__fadeInLeft">
                  <input
                    ...
                    type="text"
                    class="form__field"
                    placeholder="Message Here(30 Words)"
        ...
        <MainScreen>
          <FullPage>
            <Full>
              <h1 className="H23" style={{ cursor: "pointer" }}>
                <u>User Profile</u>
              </h1>
              <SemiFull>
                <OverlayTrigger
      ...
      <h1 className="H23" style={{ cursor: "pointer", color: "white" }}>
        .
      </h1>
      ...
      >
        ...
        <div style={{ right: 0, top: 0, margin: "30px", position: "fixed" }}>
        ...
        {!Loading && (
          <>
            <Button1 onClick={updateProfile}>Update</Button1>
